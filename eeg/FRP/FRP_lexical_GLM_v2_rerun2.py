...
dir_out = '/Volumes/Blue1TB/EEG_processed/FRP_TRF_lexical_v2_rerun2'
...
for cc in contrast_conds:
    ...
    fig.savefig(os.path.join(dir_out, f'Group_n=({len(rERP_list)})_{contrast_name}_{channels[0]}.png'))
