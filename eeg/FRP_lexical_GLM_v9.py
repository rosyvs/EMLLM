...
if REDO:
    ...
    for pID in pIDs: 
        # try:
            ...
            lexical_covariates = ['surprisal', 'log_word_freq']
            gaze_covariates = []
            ...
            plot_conds = [
                ...
                ['surprisal_WORD','log_word_freq_WORD'],
...
cond_combinations = {
    'Fixation' : ['reading/FixationWord','reading/Fixation','sham/Fixation'],
    'FRP': ['reading/FixationWord','reading/Fixation'],
    'FRP_MW=0': ['reading/FixationWord','MW=0'],
    'FRP_MW=1': ['reading/FixationWord','MW=1'], 
...
for s in rERP_list:
    ...
    for cc, clist in cond_combinations.items():
        ...
        if not clist:
            print(f'{s} does not contain any conditions for {cc}, skipping')
            continue
