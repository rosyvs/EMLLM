...
#################
# same as v2 but fixed duplicate events bug, covariates bugs
# 2d=here the surprisal and word frequency covariates are set to NA for stop words
vnum = "2_rerun4"
#################
...
exclude = [
    ...
    178,
    179,
]  # ubj to exclude because no eeg or no trigger etc.
...
if REDO:
    ...
    for pID in pIDs:
        ...
        print(f"length before drop duplicates: {len_bfore}")
        ...
        print(f"removed duplicates: {len_bfore - len(events_to_model)}")
...
contrast_conds = [
    ...
    ["surprisal_MW=0", "surprisal_MW=1"],
    ß["log_word_freq_MW=0", "log_word_freq_MW=1"],
