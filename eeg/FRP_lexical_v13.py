...
if REDO:
    ...
    for pID in pIDs: 
        # try:
            ...
            plot_conds = [
                ['FRP_WORD_SHAM','FRP_WORD_READING'],
                ['surprisal_WORD_SHAM','surprisal_WORD_READING'],
                ['log_word_freq_WORD_SHAM','log_word_freq_WORD_READING'],
                ['relative_word_position_WORD_SHAM','relative_word_position_WORD_READING'],
            ]
