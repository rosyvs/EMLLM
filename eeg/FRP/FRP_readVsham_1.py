...
# just looking for main effexts of lexical vars
vnum = 12
#################
...
if REDO:
    ...
    for pID in pIDs: 
        # try:
            ...
            cognitive_covariates = ['WORD_READING'
            ]
            ...
            plot_conds = [
                ['surprisal','surprisal_WORD_READING'],
                ['log_word_freq','log_word_freq_WORD_READING'],
                ['relative_word_position','relative_word_position_WORD_READING'],
            ]
