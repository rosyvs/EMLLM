...
ridge_alpha=1
verstr = f'FRP_TRF_lexical_v8_alpha{ridge_alpha}_decim{decimation}'
dir_out = os.path.join(dir_out_par, verstr)

# this version: as for V7 but no loinear effect of inbound cssaccade amp as this is nonlinear
        ...
        # try:
            ...
            for l in lexical_covariates:
                for c in cognitive_covariates:
                    word_fixations[f'{l}_{c}'] = word_fixations[l]*word_fixations[c]
            ...
            cond_counts['FRP'] = (events_to_model['task+type'].str.contains('FixationWord').sum())
            cond_counts['pID'] = pID
            ...
            # plotconds = ['reading/FixationWord','sham/FixationWordWord','MW=0','MW=1','surprisal','log_word_freq','relative_word_position']
